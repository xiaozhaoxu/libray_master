...
public class ClassicLoadMoreFooterView extends SwipeLoadMoreFooterLayout {
    ...
    public void onMove(int y, boolean isComplete, boolean automatic) {
        if (!isComplete) {
            ...
            if (-y >= mFooterHeight) {
                tvLoadMore.setText(R.string.cube_ptr_release_up_loading_more);
            } else {
                tvLoadMore.setText(R.string.cube_ptr_pull_up_loading_more);
            }
        }
    }
    ...
    public void onLoadMore() {
        tvLoadMore.setText(R.string.cube_ptr_refreshing);
